                                    ...
                                    <div className="details">
                                        <Table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p ><strong>Rating: </strong><span style={{ backgroundColor: "green", padding: "2px 2px", borderRadius: "5px", color: "white" }}> {ele.rating}★</span></p>
                                                    <br/>
                                                    <p><strong>Order Review: </strong> {ele.somedata}</p>
                                                    <br/>
                                                    <p><strong>Remove: </strong><DeleteIcon style={{ cursor: "pointer", color: "red", fontSize: "25" }} onClick={dlt(ele.id)}/></p>
                                                    <br/>
                                                </td>
                                            </tr>
                                        </Table>
